...
import styles from './biometric-input.scss';
...
const BiometricsInput: React.FC<BiometricsInputProps> = ({
  control,
  fieldProperties,
  fieldStyles,
  fieldWidth,
