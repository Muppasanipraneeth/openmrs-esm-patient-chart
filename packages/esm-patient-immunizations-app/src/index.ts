...
// import Immunizationschedule from './immunizations/immunization-schedule.component';
...
// export const immunizationSchedule = getSyncLifecycle(Immunizationschedule, options);
